/**
 * Zod schemas for Pen Test agent structured output.
 *
 * These schemas enforce passive-only vulnerability discovery constraints:
 * - Finding types: known_cve, version_mismatch, eol_software, missing_patch
 * - Risk ratings: critical, high, medium, low
 * - Vulnerability reports with scan_scope fixed to 'passive_only'
 * - Authorization results for the checkScanAuthorization gate
 *
 * Used by the Pen Test Edge Function for typed, parseable JSON output.
 * Frontend-compatible re-exports live in src/lib/pen-test-schemas-frontend.ts.
 */
