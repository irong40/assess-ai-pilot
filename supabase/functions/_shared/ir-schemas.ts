/**
 * Zod schemas for Incident Response agent structured output.
 *
 * These schemas enforce NIST SP 800-61r2 four-phase lifecycle constraints:
 * - Incident type classification (9 categories from NIST)
 * - Containment recommendations with mandatory approval
 * - Playbook guidance with ordered detect/contain/eradicate/recover phases
 * - Post-incident reports with compliance impact tracking
 *
 * Used by the IR Edge Function for typed, parseable JSON output.
 * Frontend-compatible re-exports live in src/lib/ir-schemas-frontend.ts.
 */
...
export type ContainmentRecommendation = z.infer<
  typeof ContainmentRecommendationSchema
>;
