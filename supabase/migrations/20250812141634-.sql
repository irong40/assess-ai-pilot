-- COMPLETE DATABASE RESET - Phase 1 Clean Schema
...
CREATE TABLE public.notification_preferences (
    ...
    enabled_categories public.notification_category[] DEFAULT ARRAY['security_incident', 'compliance_alert', 'assessment_update'],
