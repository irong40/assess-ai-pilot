...
import { ArrowLeft, Users, CheckCircle, X, AlertTriangle, Shield } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">ISSM Final Review</h1>
              <p className="text-slate-600">Review and approve assessment findings and recommendations</p>
            </div>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-slate-600">Findings Reviewed</div>
                </div>
              </div>
              ...
              <Card key={finding.id} className="border-slate-200">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600">{finding.compliance}</p>
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-900 mb-2">Business Impact</h4>
                  ...
                  <div className="border-t pt-4">
                    <h4 className="font-medium text-slate-900 mb-3">ISSM Decision</h4>
