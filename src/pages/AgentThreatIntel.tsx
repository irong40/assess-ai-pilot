...
## Compliance Score: 87/100`;
      ...
      toast({
        ...
        description: "ISSO-Threat Intelligence assessment has been completed successfully",
      });
    }, 3000);
  };
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">ISSO-Threat Intelligence Agent</h1>
              <p className="text-slate-600">Monitors threat intelligence and correlates with enterprise findings</p>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <Button 
                  ...
                  size="lg"
                >
                  {isAnalyzing ? "Analyzing..." : "Start Threat Intelligence Analysis"}
                </Button>
              </CardContent>
            </Card>
                ...
                {isAnalyzing ? (
                  <div className="flex items-center justify-center h-64">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600">Analyzing threat intelligence...</p>
                    </div>
                  </div>
                ) : analysis ? (
              ...
              <Card className="bg-green-50 border-green-200">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-semibold text-green-900 mb-2">
                    Threat Intelligence Assessment Complete!
                  </h3>
                  <p className="text-green-700 mb-4">
                    The ISSO-Threat Intelligence agent has completed its analysis. You can now proceed to other agents or review the summary.
                  </p>
                  <Button 
                    onClick={() => navigate(`/assessment/${id}/agents`)}
...
export default AgentThreatIntel;
