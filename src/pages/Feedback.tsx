      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Assessment Feedback</h1>
              <p className="text-muted-foreground">Help us improve our AI-powered cybersecurity assessments</p>
            </div>
          </div>
