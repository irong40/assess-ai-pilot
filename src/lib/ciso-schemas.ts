/**
 * CISO Orchestrator Zod schemas for structured agent output.
 *
 * These are the Node/vitest-compatible versions of the schemas.
 * The Deno Edge Function counterpart at supabase/functions/_shared/ciso-schemas.ts
 * mirrors these definitions using "npm:zod@3".
 *
 * Schemas validate:
...
export const ExecutiveSummarySchema = z.object({
  overall_posture: z.enum(['critical', 'at_risk', 'progressing', 'compliant']),
  sprs_score: z.number(),
